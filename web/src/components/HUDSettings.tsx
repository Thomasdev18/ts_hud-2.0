          ...
          <Group spacing="sm">
            ...
            <Accordion chevronPosition="right" variant="contained" sx={{ width: '100%' }}>
              <Accordion.Item value="voiceInactive">
                ...
                <Accordion.Panel>
                  <ColorInput
                    value={colors.voiceInactive || defaultColors.voiceInactive}
              ...
              <Accordion.Item value="voiceActive">
                ...
                <Accordion.Panel>
                  <ColorInput
                    value={colors.voiceActive || defaultColors.voiceActive}
              ...
              <Accordion.Item value="voiceRadio">
                ...
                <Accordion.Panel>
                  <ColorInput
                    value={colors.voiceRadio || defaultColors.voiceRadio}
              ...
              <Accordion.Item value="health">
                ...
                <Accordion.Panel>
                  <ColorInput
                    value={colors.health || defaultColors.health}
              ...
              <Accordion.Item value="armor">
                ...
                <Accordion.Panel>
                  <ColorInput
                    value={colors.armor || defaultColors.armor}
              ...
              <Accordion.Item value="thirst">
                ...
                <Accordion.Panel>
                  <ColorInput
                    value={colors.thirst || defaultColors.thirst}
              ...
              <Accordion.Item value="hunger">
                ...
                <Accordion.Panel>
                  <ColorInput
                    value={colors.hunger || defaultColors.hunger}
              ...
              <Accordion.Item value="oxygen">
                <Accordion.Control><TbLungs /> Oxygen Color</Accordion.Control>
                <Accordion.Panel>
                  <ColorInput
                    value={colors.oxygen || defaultColors.oxygen}
